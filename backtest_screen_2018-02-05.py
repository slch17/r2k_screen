...
target_date = pd.to_datetime("2018-02-05") ### THIS IS THE TARGET DATE FOR BACKTEST/ DATA COLLECTION
...
fundamental_df.to_csv('fundamental_data_2018.2.5.csv')
...
historical_df.to_csv('historical_data_2018.2.5.csv')
...
data_df.to_csv('data_df_2018.2.5.csv', index=False)
...
cumul_return_df_3y.to_csv('cumul_return_2018.2.5.csv')
